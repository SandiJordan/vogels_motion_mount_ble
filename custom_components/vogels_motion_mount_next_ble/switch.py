...
class MultiPinFeatureChangePresetsSwitch(VogelsMotionMountNextBleBaseEntity, SwitchEntity):
...
class MultiPinFeatureChangeNameSwitch(VogelsMotionMountNextBleBaseEntity, SwitchEntity):
...
class MultiPinFeatureDisableChannelSwitch(VogelsMotionMountNextBleBaseEntity, SwitchEntity):
...
class MultiPinFeatureChangeTvOnOffDetectionSwitch(
    VogelsMotionMountNextBleBaseEntity, SwitchEntity
):
