...
class NameText(VogelsMotionMountNextBleBaseEntity, TextEntity):
    ...
    def available(self) -> bool:
        ...
        return super().available and self.coordinator.data is not None and self.coordinator.data.permissions.change_name
...
class PresetNameText(VogelsMotionMountNextBlePresetBaseEntity, TextEntity):
